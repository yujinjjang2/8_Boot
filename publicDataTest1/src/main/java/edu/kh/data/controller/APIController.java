...
public class APIController {
	...
	@ResponseBody
	@RequestMapping(value="place", produces="application/json; charset=utf-8") // application/json 형식, 인코딩 utf-8
	public String place() throws Exception{ // url 때문에 IO Exception 발생해서 넘겨주는 것!
