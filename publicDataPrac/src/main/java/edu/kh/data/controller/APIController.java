...
public class APIController {
	...
	public String dataInfo() throws Exception {
		
		String url = "http://apis.data.go.kr/6480000/gnPolcCntVsCrmnlOccrrncRtNdArrstRtDataService/getgnPolcCntVsCrmnlOccrrncRtNdArrstRtData";
		// 공공데이터 항목명과 동일해야 함!
